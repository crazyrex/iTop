...
abstract class DBObject implements iDisplay
{
     ...
     *
     * You should preferably use {@see MetaModel::NewObject()} instead of this constructor.
     * The whole collection of parameters is [*optional*] please refer to {@see DBObjectSet::FromRow()}
     *
     * @api The availability of this method is not guaranteed in the long term, you should preferably use {@see MetaModel::NewObject()}.
     *
     * @param null|array   $aRow                If given : {@see DBObjectSet::FromRow()} will be used to fetch the object
     ...
     * In almost every case it is preferable to use {@see DBObject::m_bFullyLoaded}.
     *
     * @internal
     * 
     * @return bool
     ...
     * @param null|array   $aExtendedDataSpec   List of attribute that will be marked as {@see DBObject::GetExtendedData() extended data}
     *
     * @return bool
     * @throws CoreException
     */
     ...
     * The exposed API Setter is {@see DBObject::>Set()}
     *
     * @internal
     * 
     * @param $sAttCode
     ...
     * The value must be valid according to the underlying {@see AttributeDefinition}
     * - **persist**: Use {@see DBObject::DBWrite()} in order to persist the changes into the DB.
     * - **Performance**: If the object is not fully loaded, a {@see DBObject::reload()} will be triggered.
     *
     * @api
     *
     ...
     *
     * Call {@see DBObject::Set()} only of the internal representation of the attribute is null.
    ...
    /**
     * Get the {@see AttributeDefinition}'s label.
     * 
     * Shortcut to the field's {@see AttributeDefinition->GetLabel()}
     *
     * @api
     * 
     * @param string $sAttCode
     ...
     *
     * Switch to $sCode if it has a greater rank than {@see DBObject::m_sHighlightCode}}
     *          
     * @interal
     ...
     *
     * @todo: explain what is the ROLE of this method (ie: "Compute scalar attributes that depend on any other type of attribute")
	 *
	 * @api
     * @used-by DBObject::DoComputeValues()
     * @overwritable-hook You can extend this method
	 */
     ...
     * 
     * if you want to customize this behaviour, overwrite {@see DBObject::ComputeValues()}
	 *
	 * @throws \CoreException
	 * @throws \CoreUnexpectedValue
	 *
    ...
    /**
     * 
     * @see DBObject::GetAsHTML()
     * @see DBObject::GetOriginal()
     * @protected                            
     * 
     * @param string $sAttCode
     * @param bool   $bLocalize
     ...
     * 
     * @api 
     * @overwritable-hook This method is an extension point meant to be extended in order to define the read-only attributes
	 * 	 
     ...
     *
     * @overwritable-hook This method is an extension point meant to be extended in order to define the predefined objects if any.
     * 
	 ...
	 *
     * **This method is not meant to be called directly, use {@see DBObject::CheckToWrite()}!**
